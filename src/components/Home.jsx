      ...
      <div className='flex flex-col lg:flex-row text-white'>
        <div className='flex animate-fade-in text-wrap'>
          <div className='w-full'>
            ...
            <span className="text-2xl lg:text-3xl font-semibold animate-fade-in">Full-Stack Developer & AI Enthusiast</span>
            <p style={{ borderColor: color }} className='text-xl font-thin mt-4 border-solid border-l-4 pl-4 transition-colors duration-1000'>
              Welcome to my personal website! As you navigate through the pages, you'll find information about me, my skills, and my education. Feel free to reach out to me if you have any questions or are looking for Web Development services.
            </p>
          </div>
        </div>
      </div>
